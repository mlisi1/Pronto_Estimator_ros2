...
foreach(_expectedTarget pronto_ros::pronto_ros)
...
# Create imported target pronto_ros::pronto_ros
add_library(pronto_ros::pronto_ros SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/export_pronto_rosExport-*.cmake")
