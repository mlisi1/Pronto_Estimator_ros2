...
inline std::string to_yaml(const LidarOdometryUpdate & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const pronto_msgs::msg::LidarOdometryUpdate & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const pronto_msgs::msg::LidarOdometryUpdate & msg)
{
