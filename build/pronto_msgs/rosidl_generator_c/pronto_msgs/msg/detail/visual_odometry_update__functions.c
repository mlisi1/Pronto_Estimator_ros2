...
pronto_msgs__msg__VisualOdometryUpdate__init(pronto_msgs__msg__VisualOdometryUpdate * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    pronto_msgs__msg__VisualOdometryUpdate__fini(msg);
    return false;
  }
  // curr_timestamp
...
pronto_msgs__msg__VisualOdometryUpdate__create()
{
  ...
  pronto_msgs__msg__VisualOdometryUpdate * msg = (pronto_msgs__msg__VisualOdometryUpdate *)allocator.allocate(sizeof(pronto_msgs__msg__VisualOdometryUpdate), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pronto_msgs__msg__VisualOdometryUpdate));
  bool success = pronto_msgs__msg__VisualOdometryUpdate__init(msg);
  if (!success) {
...
pronto_msgs__msg__VisualOdometryUpdate__Sequence__init(pronto_msgs__msg__VisualOdometryUpdate__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pronto_msgs__msg__VisualOdometryUpdate * data = NULL;

  if (size) {
    data = (pronto_msgs__msg__VisualOdometryUpdate *)allocator.zero_allocate(size, sizeof(pronto_msgs__msg__VisualOdometryUpdate), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pronto_msgs__msg__VisualOdometryUpdate__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        pronto_msgs__msg__VisualOdometryUpdate__fini(&data[i - 1]);
      }
...
pronto_msgs__msg__VisualOdometryUpdate__Sequence__fini(pronto_msgs__msg__VisualOdometryUpdate__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      pronto_msgs__msg__VisualOdometryUpdate__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pronto_msgs__msg__VisualOdometryUpdate__Sequence * array = (pronto_msgs__msg__VisualOdometryUpdate__Sequence *)allocator.allocate(sizeof(pronto_msgs__msg__VisualOdometryUpdate__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pronto_msgs__msg__VisualOdometryUpdate__Sequence__init(array, size);
  if (!success) {
...
pronto_msgs__msg__VisualOdometryUpdate__Sequence__destroy(pronto_msgs__msg__VisualOdometryUpdate__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pronto_msgs__msg__VisualOdometryUpdate__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pronto_msgs__msg__VisualOdometryUpdate__Sequence__are_equal(const pronto_msgs__msg__VisualOdometryUpdate__Sequence * lhs, const pronto_msgs__msg__VisualOdometryUpdate__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pronto_msgs__msg__VisualOdometryUpdate__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pronto_msgs__msg__VisualOdometryUpdate__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pronto_msgs__msg__VisualOdometryUpdate);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pronto_msgs__msg__VisualOdometryUpdate * data =
      (pronto_msgs__msg__VisualOdometryUpdate *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pronto_msgs__msg__VisualOdometryUpdate__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pronto_msgs__msg__VisualOdometryUpdate__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!pronto_msgs__msg__VisualOdometryUpdate__copy(
