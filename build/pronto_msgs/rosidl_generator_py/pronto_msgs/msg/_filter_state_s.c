...
bool pronto_msgs__msg__filter_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pronto_msgs.msg._filter_state.FilterState", full_classname_dest, 41) == 0);
  }
  pronto_msgs__msg__FilterState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of FilterState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pronto_msgs.msg._filter_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FilterState");
