...
class Metaclass_JointStateWithAcceleration(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'pronto_msgs.msg.JointStateWithAcceleration')
            logger.debug(
...
class JointStateWithAcceleration(metaclass=Metaclass_JointStateWithAcceleration):
