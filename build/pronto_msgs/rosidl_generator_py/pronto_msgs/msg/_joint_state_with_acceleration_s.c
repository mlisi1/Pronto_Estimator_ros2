...
bool pronto_msgs__msg__joint_state_with_acceleration__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pronto_msgs.msg._joint_state_with_acceleration.JointStateWithAcceleration", full_classname_dest, 73) == 0);
  }
  pronto_msgs__msg__JointStateWithAcceleration * ros_message = _ros_message;
  {  // header
...
PyObject * pronto_msgs__msg__joint_state_with_acceleration__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pronto_msgs.msg._joint_state_with_acceleration");
