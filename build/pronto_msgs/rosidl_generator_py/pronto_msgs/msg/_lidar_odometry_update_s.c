...
bool pronto_msgs__msg__lidar_odometry_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pronto_msgs.msg._lidar_odometry_update.LidarOdometryUpdate", full_classname_dest, 58) == 0);
  }
  pronto_msgs__msg__LidarOdometryUpdate * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LidarOdometryUpdate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pronto_msgs.msg._lidar_odometry_update");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LidarOdometryUpdate");
