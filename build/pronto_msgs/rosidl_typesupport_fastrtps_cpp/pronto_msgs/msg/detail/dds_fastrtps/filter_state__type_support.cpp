...
#include "pronto_msgs/msg/detail/filter_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pronto_msgs::msg::FilterState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pronto_msgs::msg::FilterState & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pronto_msgs
max_serialized_size_FilterState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pronto_msgs::msg::FilterState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pronto_msgs::msg::FilterState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pronto_msgs::msg::FilterState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FilterState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pronto_msgs::msg::FilterState *>(
...
static size_t _FilterState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FilterState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FilterState__callbacks = {
  "pronto_msgs::msg",
  "FilterState",
...
static rosidl_message_type_support_t _FilterState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FilterState__callbacks,
...
{
  return &pronto_msgs::msg::typesupport_fastrtps_cpp::_FilterState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pronto_msgs, msg, FilterState)() {
  return &pronto_msgs::msg::typesupport_fastrtps_cpp::_FilterState__handle;
}
