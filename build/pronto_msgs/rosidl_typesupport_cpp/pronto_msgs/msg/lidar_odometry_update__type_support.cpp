...
static const _LidarOdometryUpdate_type_support_symbol_names_t _LidarOdometryUpdate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pronto_msgs, msg, LidarOdometryUpdate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pronto_msgs, msg, LidarOdometryUpdate)),
  }
};
...
{
  return &::pronto_msgs::msg::rosidl_typesupport_cpp::LidarOdometryUpdate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pronto_msgs, msg, LidarOdometryUpdate)() {
  return get_message_type_support_handle<pronto_msgs::msg::LidarOdometryUpdate>();
}
