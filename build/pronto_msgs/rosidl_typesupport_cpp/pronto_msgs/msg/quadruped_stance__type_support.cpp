...
static const _QuadrupedStance_type_support_symbol_names_t _QuadrupedStance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pronto_msgs, msg, QuadrupedStance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pronto_msgs, msg, QuadrupedStance)),
  }
};
...
{
  return &::pronto_msgs::msg::rosidl_typesupport_cpp::QuadrupedStance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pronto_msgs, msg, QuadrupedStance)() {
  return get_message_type_support_handle<pronto_msgs::msg::QuadrupedStance>();
}
