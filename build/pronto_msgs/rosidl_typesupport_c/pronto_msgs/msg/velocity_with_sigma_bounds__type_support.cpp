...
static const _VelocityWithSigmaBounds_type_support_symbol_names_t _VelocityWithSigmaBounds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pronto_msgs, msg, VelocityWithSigmaBounds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pronto_msgs, msg, VelocityWithSigmaBounds)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pronto_msgs, msg, VelocityWithSigmaBounds)() {
  return &::pronto_msgs::msg::rosidl_typesupport_c::VelocityWithSigmaBounds_message_type_support_handle;
}
