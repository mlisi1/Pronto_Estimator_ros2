...
static const _BipedForceTorqueSensors_type_support_symbol_names_t _BipedForceTorqueSensors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pronto_msgs, msg, BipedForceTorqueSensors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pronto_msgs, msg, BipedForceTorqueSensors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pronto_msgs, msg, BipedForceTorqueSensors)() {
  return &::pronto_msgs::msg::rosidl_typesupport_c::BipedForceTorqueSensors_message_type_support_handle;
}
