...
static const _JointStateWithAcceleration_type_support_symbol_names_t _JointStateWithAcceleration_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pronto_msgs, msg, JointStateWithAcceleration)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pronto_msgs, msg, JointStateWithAcceleration)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pronto_msgs, msg, JointStateWithAcceleration)() {
  return &::pronto_msgs::msg::rosidl_typesupport_c::JointStateWithAcceleration_message_type_support_handle;
}
