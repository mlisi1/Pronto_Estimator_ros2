...
#include "pronto_msgs/msg/detail/biped_force_torque_sensors__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/wrench__functions.h"  // l_foot, l_hand, r_foot, r_hand
...
using _BipedForceTorqueSensors__ros_msg_type = pronto_msgs__msg__BipedForceTorqueSensors;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BipedForceTorqueSensors__ros_msg_type * ros_message = static_cast<const _BipedForceTorqueSensors__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BipedForceTorqueSensors__ros_msg_type * ros_message = static_cast<_BipedForceTorqueSensors__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_pronto_msgs__msg__BipedForceTorqueSensors(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BipedForceTorqueSensors__ros_msg_type * ros_message = static_cast<const _BipedForceTorqueSensors__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BipedForceTorqueSensors__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pronto_msgs__msg__BipedForceTorqueSensors(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pronto_msgs
size_t max_serialized_size_pronto_msgs__msg__BipedForceTorqueSensors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pronto_msgs__msg__BipedForceTorqueSensors;
    is_plain =
      (
...
static size_t _BipedForceTorqueSensors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pronto_msgs__msg__BipedForceTorqueSensors(
...
static message_type_support_callbacks_t __callbacks_BipedForceTorqueSensors = {
  "pronto_msgs::msg",
...
static rosidl_message_type_support_t _BipedForceTorqueSensors__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BipedForceTorqueSensors,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pronto_msgs, msg, BipedForceTorqueSensors)() {
  return &_BipedForceTorqueSensors__type_support;
}
