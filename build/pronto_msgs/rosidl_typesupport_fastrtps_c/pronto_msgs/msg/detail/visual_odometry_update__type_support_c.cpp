...
#include "pronto_msgs/msg/detail/visual_odometry_update__rosidl_typesupport_fastrtps_c.h"
...
using _VisualOdometryUpdate__ros_msg_type = pronto_msgs__msg__VisualOdometryUpdate;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VisualOdometryUpdate__ros_msg_type * ros_message = static_cast<const _VisualOdometryUpdate__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _VisualOdometryUpdate__ros_msg_type * ros_message = static_cast<_VisualOdometryUpdate__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_pronto_msgs__msg__VisualOdometryUpdate(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VisualOdometryUpdate__ros_msg_type * ros_message = static_cast<const _VisualOdometryUpdate__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VisualOdometryUpdate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pronto_msgs__msg__VisualOdometryUpdate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pronto_msgs
size_t max_serialized_size_pronto_msgs__msg__VisualOdometryUpdate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pronto_msgs__msg__VisualOdometryUpdate;
    is_plain =
      (
...
static size_t _VisualOdometryUpdate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pronto_msgs__msg__VisualOdometryUpdate(
...
static message_type_support_callbacks_t __callbacks_VisualOdometryUpdate = {
  "pronto_msgs::msg",
...
static rosidl_message_type_support_t _VisualOdometryUpdate__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VisualOdometryUpdate,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pronto_msgs, msg, VisualOdometryUpdate)() {
  return &_VisualOdometryUpdate__type_support;
}
